...
| 02 | [NLP Basics](./02_nlp_basics/) | tokenization, vocabulary, embedding | In progress |
| 03 | [Attention Mechanism](./03_attention/) | Q, K, V, softmax, self-attention | In progress  |
| 04 | [mini-GPT](./04_mini_gpt/) | transformer, text generation | In progress  |
| 05 | [HuggingFace & GPT2](./05_huggingface/) | pipeline, fine-tuning, real LLM | In progress |
